  ...
  return (
    <>
      <div className="rounded mb-8 w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
        <div>This example shows how to use Saleor Auth SDK with urql as GraphQL client.</div>
        <div className="mt-2">
          Login form: <code className="font-mono font-bold">app/urql/page.tsx</code>
        </div>
        <div>
          Provider configuration: <code className="font-mono font-bold">app/urql/layout.tsx</code>
        </div>
      </div>
      {data?.me ? (
        <>
